...
exports.INTERPRETATION_SYSTEM_PROMPT = exports.EXTRACTION_SYSTEM_PROMPT = void 0;
exports.buildExtractionUserPrompt = buildExtractionUserPrompt;
exports.buildInterpretationUserPrompt = buildInterpretationUserPrompt;
exports.EXTRACTION_SYSTEM_PROMPT = `You are a literary analyst extracting narrative structure from text. Your job is to produce an exhaustive, neutral, objective extraction — no interpretation, no significance scores, no thematic analysis. Just what's in the text.
...
function buildExtractionUserPrompt(text, lineCount) {
...
exports.INTERPRETATION_SYSTEM_PROMPT = `You are a literary critic constructing an interpretive reading of a narrative. You will be given:
...
function buildInterpretationUserPrompt(textModelJson, lens) {
